...
public class EducationService : IEducationService
{
    ...
    public async Task<UserEducationHistory?> GetEducationByIdAsync(int educationId, int userId)
    {
        return await _context.UserEducationHistories
    ...
    /// <summary>
    /// Trims string properties of the education history record.
    /// </summary>
    /// <param name="education">The education history record.</param>
    private void TrimStrings(UserEducationHistory education)
    {
